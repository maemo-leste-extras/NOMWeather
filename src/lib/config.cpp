...
static const QHash<ConfigKeys::ConfigKey, ConfigDirective> configStrings = {
  {ConfigKeys::SettingsLocationChoice,{QS("SettingsLocationChoice"), "network"}},
  {ConfigKeys::SettingsLocationName,{QS("SettingsLocationName"), ""}},
  {ConfigKeys::SettingsLocationCountry,{QS("SettingsLocationCountry"), ""}},
  {ConfigKeys::SettingsLocation,{QS("SettingsLocation"), ""}},
  {ConfigKeys::SettingsLocationLat,{QS("SettingsLocationLat"), ""}},
  {ConfigKeys::SettingsLocationLon,{QS("SettingsLocationLon"), ""}},
  {ConfigKeys::SettingsTempType,{QS("SettingsTempType"), "celcius"}}
};
